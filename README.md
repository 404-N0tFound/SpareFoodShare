...
### Update
    -Add upload function to insert data to database.
    -Delete price column of items.
    -Change isprivate column's data type from boolean to number(as I'm still looking on how to record boolean values via serializer)