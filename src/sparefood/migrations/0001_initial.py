    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_des', models.TextField(max_length=10000, verbose_name='item_des')),
                ...
                ('item_provider', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, to_field='email')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('order_collected_date', models.DateTimeField(blank=True, null=True)),
                ('order_collection_location', models.CharField(max_length=240, verbose_name='order_location')),
                ('order_initiator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, to_field='email')),
